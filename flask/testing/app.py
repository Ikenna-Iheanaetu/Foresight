...
# converting the target to a numerical variable
le = LabelEncoder()
data[target] = le.fit_transform(data[target])

# load the file 
model_filename = "General Sickness.pkl"
